...
class BraceletsControllerTest < ActionController::TestCase
  ...
  test "should create bracelet" do
    assert_difference('Bracelet.count') do
      post :create, bracelet: { casp: @bracelet.casp, clasp: @bracelet.clasp, color_position_id: @bracelet.color_position_id, price: @bracelet.price, row_number_id: @bracelet.row_number_id }
    end
  ...
  test "should update bracelet" do
    patch :update, id: @bracelet, bracelet: { casp: @bracelet.casp, clasp: @bracelet.clasp, color_position_id: @bracelet.color_position_id, price: @bracelet.price, row_number_id: @bracelet.row_number_id }
    assert_redirected_to bracelet_path(assigns(:bracelet))
  end
